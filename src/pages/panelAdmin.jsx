...
<div className='w-full h-full'>
    <div className={`absolute bg-[#b2b42d] lg:w-[25%] w-[60%] h-full py-[2rem] lg:px-[2rem] px-[1.3rem] flex flex-col gap-10 items-start transition-transform ${menu ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        { numberRol === 1 && (
          ...
          <button className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]' onClick={()=>openModal('opcion4')}>Subir Altas</button>
          </div>
          <div className='flex gap-5'>
        ...
        {numberRol === 3 && (
          ...
          <button className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]' onClick={()=>openModal('opcion6')}>Administrar Altas</button>
          </div>
          <div className='flex gap-5'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m13 7-6 6m0-6 6 6m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
        ...
        {numberRol === 4 && (
          ...
          <button className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]' onClick={()=>openModal('opcion10')}>Crear Usuario</button>
          </div>
          <div className='flex gap-5'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 8h6m-9-3.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0ZM5 11h3a4 4 0 0 1 4 4v2H1v-2a4 4 0 0 1 4-4Z"/>
          </svg>
          <button className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]' onClick={()=>openModal('opcion12')}>Eliminar Usuario</button>
          </div>
          <div className='flex gap-5'>
          ...
          <button className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]' onClick={()=>openModal('opcion11')}>Asignación de folios</button>
          </div>
          <div className='flex gap-5'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
          <path stroke="currentColor" stroke-linejoin="round" stroke-width="2" d="M8 8v1h4V8m4 7H4a1 1 0 0 1-1-1V5h14v9a1 1 0 0 1-1 1ZM2 1h16a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Z"/>
    ...
    {mostrarModal && (
      ...
      {opcionSelect === 'opcion1' && (
        ...
        {opcionSelect === 'opcion10' && (
         <Crear_usuarioRol4/>
        )}
        {opcionSelect === 'opcion11' && (
         <Asing_foliosRol4/>
        )}
