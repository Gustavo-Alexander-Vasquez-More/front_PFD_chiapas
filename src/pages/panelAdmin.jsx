...
<div className='w-full h-full'>
    <div className={`absolute bg-[#17103a] w-[30%] h-full py-[2rem] px-[2rem] flex flex-col gap-10 items-start transition-transform ${menu ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <button className='hover:text-[#370080] text-white' onClick={()=>openModal('opcion3')}>Administrar Usuario</button>
        </div>
        <div className='flex gap-5'>
        ...
        <button className='hover:text-[#370080] text-white' onClick={()=>openModal('opcion4')}>Subir antecedente</button>
        </div>
        <div className='flex gap-5'>
        ...
        <button className='hover:text-[#370080] text-white' onClick={()=>openModal('opcion5')}>Eliminar antecedente</button>
        </div>
        <div className='flex gap-5'>
        ...
        <button className='hover:text-[#370080] text-white' onClick={()=>openModal('opcion6')}>Cerrar sesión</button>
        </div>
