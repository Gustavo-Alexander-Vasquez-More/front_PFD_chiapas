...
<div className='w-full h-full'>
    <div className={`absolute bg-[#17103a] w-[30%] h-full py-[2rem] px-[2rem] flex flex-col gap-10 items-start transition-transform ${menu ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <button className='hover:text-[#370080] text-white' onClick={()=>openModal('opcion1')}>Crear Usuario</button>
        </div>
        <div className='flex gap-5'>
        <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
        ...
        <button className='hover:text-[#370080] text-white' onClick={()=>openModal('opcion2')}>Eliminar Usuario</button>
        </div>
        <div className='flex gap-5'>
        ...
        <button className='hover:text-[#370080] text-white' onClick={()=>openModal('opcion3')}>Asignación de folios</button>
        </div>
        <div className='flex gap-5'>
        ...
        <button className='hover:text-[#370080] text-white' onClick={()=>openModal('opcion4')}>Subir Altas</button>
        </div>
        <div className='flex gap-5'>
        ...
        <button className='hover:text-[#370080] text-white' onClick={()=>openModal('opcion5')}>Administrar Altas</button>
        </div>
        <div className='flex gap-5'>
        ...
        <button  className='hover:text-[#370080] text-white' onClick={LogOut}>Cerrar sesión</button>
        </div>
        
    </div>
    <div className="w-full h-[10vh] flex items-center bg-[#17103a] justify-between px-[2rem] ">
        ...
        <p className='text-[2rem] text-white'>Panel de Administrador</p>
        <div  className='flex'>
            <p className='text-white flex gap-3 text-[1.3rem]'>Hola {user}! <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 18">
    ...
    <div className='w-full h-[90vh] bg-[url("https://static.vecteezy.com/system/resources/previews/005/554/444/non_2x/abstract-elegant-white-and-grey-background-abstract-white-pattern-squares-texture-free-vector.jpg")] bg-cover'>
      <div className='flex flex-col items-center w-full h-[70vh] justify-around'>
        <p className='text-[3rem]'>Sistema de Altas</p>
