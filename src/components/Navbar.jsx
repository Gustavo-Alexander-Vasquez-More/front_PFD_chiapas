...
<div className='w-full h-full'>
    <div className={`absolute bg-[#b2b42d] lg:w-[25%] w-[80%] h-full py-[2rem] lg:px-[2rem] px-[1.3rem] flex flex-col gap-4 items-start transition-transform ${menu ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        { numberRol === 1 && (
          ...
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5"/>
</svg>
          <Anchor to={'/panelAdmin'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Inicio</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
          ...
          <Anchor to={'/create_users'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Crear Usuario</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
          ...
          <Anchor to={'/delete_users'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Eliminar Usuario</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Anchor to={'/asign_folios'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Asignación de folios</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
          <path stroke="currentColor" stroke-linejoin="round" stroke-width="2" d="M8 8v1h4V8m4 7H4a1 1 0 0 1-1-1V5h14v9a1 1 0 0 1-1 1ZM2 1h16a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Z"/>
          </svg>
          <Anchor to={'/create_antecedentes'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Subir Altas</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h16M7 8v8m4-8v8M7 1h4a1 1 0 0 1 1 1v3H6V2a1 1 0 0 1 1-1ZM3 5h12v13a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5Z"/>
          </svg>
          <Anchor to={'/altas_usuarios'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Administrar Altas</Anchor>
          </div>
          <div className='flex gap-3'>
          ...
          <Anchor to={'/update_password'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Cambiar contraseñas</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          <path fill-rule="evenodd" d="M5 8a4 4 0 1 1 7.796 1.263l-2.533 2.534A4 4 0 0 1 5 8Zm4.06 5H7a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h2.172a2.999 2.999 0 0 1-.114-1.588l.674-3.372a3 3 0 0 1 .82-1.533L9.06 13Zm9.032-5a2.907 2.907 0 0 0-2.056.852L9.967 14.92a1 1 0 0 0-.273.51l-.675 3.373a1 1 0 0 0 1.177 1.177l3.372-.675a1 1 0 0 0 .511-.273l6.07-6.07a2.91 2.91 0 0 0-.944-4.742A2.907 2.907 0 0 0 18.092 8Z" clip-rule="evenodd"/>
          </svg>
          <Anchor to={'/update_rol'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Cambiar Rol</Anchor>
          </div>
          <div className='flex gap-3'>
          ...
          <Anchor to={'/user_conected'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Usuarios conectados</Anchor>
          </div>
          ...
          <Anchor to={'/registro_users'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Registro usuarios</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.333 6.764a3 3 0 1 1 3.141-5.023M2.5 16H1v-2a4 4 0 0 1 4-4m7.379-8.121a3 3 0 1 1 2.976 5M15 10a4 4 0 0 1 4 4v2h-1.761M13 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-4 6h2a4 4 0 0 1 4 4v2H5v-2a4 4 0 0 1 4-4Z"/>
          </svg>
          <Anchor to={'/registro_folios'}  className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Registro asignaciones</Anchor>
          </div>
            </>
          )}
          <div className='flex gap-3'>
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5"/>
          ...
          <Anchor to={'/mis_antecedentes'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Administrar Altas</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m13 7-6 6m0-6 6 6m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5"/>
          ...
          <Anchor to={'/create_users_revendedor'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Crear Usuario</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 8h6m-9-3.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0ZM5 11h3a4 4 0 0 1 4 4v2H1v-2a4 4 0 0 1 4-4Z"/>
          </svg>
          <Anchor to={'/delete_admins_revendedor'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Eliminar Usuario</Anchor>
          </div>
          <div className='flex gap-3'>
          ...
          <Anchor to={'/asign_folios_revendedor'} className='hover:text-[#370080] text-white lg:text-[1rem] text-[0.8rem]'>Asignación de folios</Anchor>
          </div>
          <div className='flex gap-3'>
          <svg class="lg:w-6 lg:h-6 w-4 h-4 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
          <path stroke="currentColor" stroke-linejoin="round" stroke-width="2" d="M8 8v1h4V8m4 7H4a1 1 0 0 1-1-1V5h14v9a1 1 0 0 1-1 1ZM2 1h16a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Z"/>
